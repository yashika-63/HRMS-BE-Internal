...
@NoArgsConstructor
@Data
public class OfferCTCBreakdownHeader {
    ...
    @OneToMany(mappedBy = "offerCTCBreakdownHeader", cascade = CascadeType.ALL, orphanRemoval = true)
    private List<OfferVariableCTCBreakdown> offerVariableCTCBreakdowns;

    @OneToMany(mappedBy = "offerCTCBreakdownHeader", cascade = CascadeType.ALL, orphanRemoval = true)
    private List<OfferStaticCTCBreakdown> offerStaticCTCBreakdowns;
